    ...
    <div className="space-y-6">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-zinc-400 mt-1">Cadastre os serviços que sua barbearia oferece.</p>
        </div>
      ...
      {services.length === 0 ? (
        <div className="rounded-lg border border-dashed border-zinc-800 p-12 flex flex-col items-center text-center gap-4">
          ...
          <div>
            <p className="text-base font-medium text-white">Nenhum serviço cadastrado ainda</p>
